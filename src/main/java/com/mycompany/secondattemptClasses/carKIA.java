...
public final class carKIA {
     ...
     private final List<Vehicle> vehicles;
      ...
      private carKIA(carKIA.Builder builder){
    ...
    public boolean equals(Object vehicleObject) {
        ...
        if (vehicleObject == null || getClass() != vehicleObject.getClass()) return false;
         ...
         carKIA carkias = (carKIA) vehicleObject;

        if (!CarModel.equals(carkias.CarModel)) return false;
