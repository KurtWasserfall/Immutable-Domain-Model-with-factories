 ...
 */
public final class carMERCEDEZ {
     ...
     private final List<Vehicle> vehicles;
      ...
      private carMERCEDEZ(carMERCEDEZ.Builder builder){
    ...
    public Builder Damaged(String value){
      ...
      public Builder PartNo(String value){
        ...
        public Builder vehicles(List<Vehicle> value){
         ...
         public carMERCEDEZ build(){
            return new carMERCEDEZ(this);
        }
    }
    ...
    public boolean equals(Object vehicleObject) {
        ...
        if (vehicleObject == null || getClass() != vehicleObject.getClass()) return false;
         ...
         carMERCEDEZ carmercs = (carMERCEDEZ) vehicleObject;

        if (!CarModel.equals(carmercs.CarModel)) return false;
