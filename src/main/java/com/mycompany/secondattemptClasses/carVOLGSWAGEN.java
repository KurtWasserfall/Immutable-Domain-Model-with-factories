 ...
 */
public final class carVOLGSWAGEN {
     ...
     private final List<Vehicle> vehicles;
      ...
      private carVOLGSWAGEN (carVOLGSWAGEN.Builder builder){
    ...
    public Builder Damaged(String value){
      ...
      public Builder PartNo(String value){
        ...
        public Builder vehicles(List<Vehicle> value){
         ...
         public carVOLGSWAGEN  build(){
            return new carVOLGSWAGEN (this);
        }
    }
    ...
    {
     return "Manufacturer VOLGSWAGEN"+"\nCar Model: "+this.CarModel+"\nColour: "+this.Colour+
    ...
    public boolean equals(Object vehicleObject) {
        ...
        carVOLGSWAGEN  carfoxies = (carVOLGSWAGEN ) vehicleObject;

        if (!CarModel.equals(carfoxies.CarModel)) return false;
