...
public final class carMAZDA {
     ...
     private final List<Vehicle> vehicles;
      ...
      private carMAZDA(carMAZDA.Builder builder){
    ...
    public Builder Damaged(String value){
      ...
      public Builder PartNo(String value){
        ...
        public Builder vehicles(List<Vehicle> value){
         ...
         public carMAZDA build(){
            return new carMAZDA(this);
        }
    }
    ...
    public boolean equals(Object vehicleObject) {
        ...
        carMAZDA carmazdas = (carMAZDA) vehicleObject;

        if (!CarModel.equals( carmazdas.CarModel)) return false;
